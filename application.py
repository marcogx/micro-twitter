...
application.secret_key = '^tnm!&xvm!gor-l^jh$8jqmp^@q3dtwurv7nz*+j3tk=t%16o4'
...
@application.route('/')
def index():
	stream = models.Post.select().limit(7)
	return render_template('stream.html', stream=stream)


@application.route('/stream')
@application.route('/stream/<username>')
...
def follow(username):
	...
	return redirect(url_for('streaming', username=to_user.username))
